...
container_run_script_smartExecutor_rl="run_smartExecutor_v5.3_rl.sh"
 
export container_run_script_mythril container_run_script_smartExecutor container_run_script_smartExecutor_rl
