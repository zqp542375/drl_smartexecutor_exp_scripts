...
container_work_dir_smartExecutor_rl="/home/smartExecutor/"
image_smartExecutor_rl=b57228540e04#v5.3

export container_work_dir_smartExecutor image_smartExecutor_v3 image_smartExecutor_rl
